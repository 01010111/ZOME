...
class DeleteLevel implements IModal
{
	...
	function init()
	{
		element = document.getElementById('delete_level_modal');
		...
		button.onclick = (e) -> {
			App.i.levels.delete_level(level);
			close();
		}
	...
	{
		text.innerHTML = 'Are you sure you want to delete the level "${level.name}"? Its contents will be lost forever!';
